 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -1 }
 ...
 * these options to REre the prior leveling state or to always enable
...
#define HOMING_FEEDRATE_MM_M { (120*60), (120*60), (4*60) }
